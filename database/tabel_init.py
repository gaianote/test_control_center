...
database.create_table('PROJECT',ID = 'INTEGER PRIMARY KEY AUTOINCREMENT', NAME = 'TEXT',INFO = 'TEXT',CREATE_DATE = 'TEXT',UPDATE_DATE = 'TEXT',USER = 'TEXT',SORTORDER = 'INTEGER',IS_DELETED = 'INTEGER',STATE = 'TEXT',LOOP = 'INTEGER',PROJECTPATH = 'TEXT',ENTRYORDER = 'TEXT')
...
BEGIN
   UPDATE ITEM SET SORTORDER = new.ID, CREATE_DATE = datetime('now'),IS_DELETED = 0 ,IS_EXECUTE = "checked" WHERE ID = new.ID;
END;
""")
database.execute("""
